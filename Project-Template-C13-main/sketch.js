...
function preload(){
  ...
  // red_balloonImage = loadImage("redballoon0.png"); not this one
  // red_balloonImage = loadImage("red_balloon0"); not this one
  //red_balloonImage = loadImage("red_balloon0.png"); not this one
